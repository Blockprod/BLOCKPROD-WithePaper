...
### **III. BP Token Utility and Incentive Game**
...
The native token of the ecosystem will be BP.  The BP token will be used in the DAO for voting rights to approve or deny proposals for upgrading the platform, amount for listing/upload fees, and Treasury control.  BP will also be stakeable in the Content Mining operation which will decide what gets listed on the protocol and what doesn’t.

## <p align="center"> <img src="images/BP Utility.png" /> </p>
...
2. Validators stake a minimum number of BP, the more BP they stake the higher their vote is in determining what gets validated onto the platform.  They are rewarded for their work and penalized for their mistakes.
...
## <p align="center"> <img src="images/BprodPlatform.png" /> </p>

The BP DAO framework is designed so that it starts as a simple kernel that can grow, or decrease, in complexity according to the needs of the platform determined by the community. The DAO will have three controls from the start.
...
2. **BP Media Distribution Protocol parameter settings:** The Staking and Transaction Fees are allocated to the Treasury of the DAO. A Validation Fee is paid to the Validators.  All parameters are voted on and set by the DAO.
                 
       a. Validation Fee: Minimum amount paid to validators
       b. Listing Fee: The minimum amount of BP needed to be staked to have content mined onto the platform
...
## <p align="center"> <img src="images/BPProposalFlow.png" /> </p>
...
2. If the Validator fees are market correct, Validators will start verifying the content and they can vote up or down the entry.
       ...
       a. The more BP a validator has staked, the more their vote counts.
...
3. Once the voting is done, no matter if the entry was accepted or not, the Validators are rewarded the fee proportional to their voting weight.
       ...
       a. If content is rejected the Content Creators are returned their initial BP stake (Listing Fee).
       ...
       b. If the content is accepted the initial BP stake (Listing Fee) is sent to the Treasury that is controlled by the DAO.
...
## <p align="center"> <img src="images/BPContentMining.png" /> </p>

In the event a piece of content is accepted into the system that is deemed not to be appropriate (ie copyrighted), the Validators will need to vote it out of the system.  When the content is voted off the system the original curators that voted “yes” will be penalized and lose their rewarded BP payment. 
...
## <p align="center"> <img src="images/BPWEB2Curation.png" /> </p>
...
## <p align="center"> <img src="images/BPWEB3Curation.png" /> </p>

## VII. Glossary
1. **BP DApp:** A high end content portal that sits on top of the BP media distribution protocol. Handles the processes that need a legal entity for the traditional Hollywood world and banking system charging a 20% service fee.
2. **BP Media Distribution Protocol:** A trustless global media distribution protocol anyone can come in and build on top of spurring a decentralized entertainment economy, controlled by the BP DAO.
...
13. **Treasury:** Repository where the Transaction Fees and BP that are from Staking for curation are stored and controlled by the DAO.
14. **Validation Fee:** Minimum amount paid to validators to vote yes or no on a piece of content.
15. **Listing Fee:** The amount of the BP needed to stake to potentially mine the content onto the platform.
16. **Transaction Fee:** The percentage taken on every transaction of a rented or purchased piece of content.
17. **Grants:** Capital allocated from the BP DAO Treasury to proposals for development.
